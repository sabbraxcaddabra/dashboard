...
from 
(select
  consent.sspriem_mark as ss_agr, enrolled.application_id as app_id, enrolled.decree_id as decree_id, enrolled.decree_del as decree_del, ab.id as abId, gender.id as genId, gender.name as genN, ifnull((select region.id from address join region on region.id = address.region_id 
